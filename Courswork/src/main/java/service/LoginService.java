...
public class LoginService {
	...
	public Boolean loginUser(StudentModel studentModel) {
		...
		String query = "SELECT username, password,role,student_id FROM student WHERE username = ?";
	...
	private boolean validatePassword(ResultSet result, StudentModel studentModel) throws SQLException {
		...
		int dbid = result.getInt("student_id");
		
		studentModel.setRole(dbRole);
		studentModel.setId(dbid);
